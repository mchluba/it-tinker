$TG_BOT_API_KEY = 'INSERT API KEY HERE' #Telegram Bot API-KEY
$AZ_TRANSLATION_API_KEY = 'INSERT API KEY HERE' # Azure Translation API KEY
$AZ_SPEECH2TEXT_API_KEY = 'INSERT API KEY HERE' #Azure Text-to-Speech API KEY
